...
def train_autoencoder(parsed_csv, labels_csv, epochs=15, batch_size=32, max_len=10):
    ...
    result.to_csv("/home/claude/log-anomaly-detector/outputs/lstm_autoencoder_results.csv", index=False)
    torch.save(model.state_dict(), "/home/claude/log-anomaly-detector/models/lstm_autoencoder.pt")
    print("Saved predictions -> outputs/lstm_autoencoder_results.csv")
    print("Saved model       -> models/lstm_autoencoder.pt")
    return model, result
